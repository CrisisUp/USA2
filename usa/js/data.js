...
export const stateData = {
    ...
    "AK": { name: "Alaska", media: [
        ...
        { type: "Filme", title: "A Proposta", description: "Uma editora de livros canadense força seu assistente a se casar com ela para evitar a deportação, mas as coisas mudam em uma viagem ao Alasca.", cover: "images/AK/a-proposta.jpg", rating: "6.7/10", imdbLink: "https://www.imdb.com/title/tt1142977/" }, 
    ...
    "MA": { name: "Massachusetts", media: [
        ...
        { type: "Filme", title: "Manchester à Beira-Mar", description: "Um zelador tem que cuidar de seu sobrinho adolescente após a morte do pai.", cover: "images/MA/manchester-a-beira-mar.jpg", rating: "7.8/10", imdbLink: "https://www.imdb.com/title/tt4034228/" }, 

        { type: "Filme", title: "A Rede Social", description: "A história da fundação do Facebook por Mark Zuckerberg, em Harvard.", cover: "images/MA/a-rede-social.png", rating: "7.8/10", imdbLink: "https://www.imdb.com/title/tt1285016/" }] },
    ...
    "ID": { name: "Idaho", media: [
        ...
        { type: "Filme", title: "Napoleão Dinamite", description: "Um nerd socialmente desajeitado tenta ajudar seu amigo a vencer as eleições estudantis.", cover: "images/ID/napoleao-dinamite.jpg", rating: "6.9/10", imdbLink: "https://www.imdb.com/title/tt0359345/" }, 

        { type: "Filme", title: "My Own Private Idaho", description: "Dois amigos, um deles narcoléptico, embarcam em uma jornada para encontrar a mãe do primeiro.", cover: "images/ID/my-own-private-idaho.jpg", rating: "7.3/10", imdbLink: "https://www.imdb.com/title/tt0102494/" }] },
    ...
    "AZ": { name: "Arizona", media: [
        ...
        { type: "Filme", title: "Arizona Nunca Mais", description: "Um ex-presidiário e uma policial se casam e roubam um bebê.", cover: "images/AZ/arizona-nunca-mais.png", rating: "7.3/10", imdbLink: "https://www.imdb.com/title/tt0093822/" }, 
        
        { type: "Filme", title: "Tombstone", description: "Wyatt Earp e seus irmãos se mudam para Tombstone, Arizona, onde confrontam foras da lei.", cover: "images/AZ/tombstone.jpg", rating: "7.8/10", imdbLink: "https://www.imdb.com/title/tt0108358/" }] },

    "CO": { name: "Colorado", media: [

        { type: "Filme", title: "O Iluminado", description: "Um escritor aceita um emprego como zelador de inverno em um hotel isolado, que tem um passado sombrio.", cover: "images/CO/o-iluminado.jpg", rating: "8.4/10", imdbLink: "https://www.imdb.com/title/tt0081505/" }, 

        { type: "Filme", title: "Encontro Explosivo", description: "Uma mulher é arrastada para o mundo de um agente secreto, que a leva em uma fuga global.", cover: "images/CO/encontro-explosivo.jpg", rating: "6.3/10", imdbLink: "https://www.imdb.com/title/tt1013721/" }] },
    ...
    "NV": { name: "Nevada", media: [
        ...
        { type: "Série", title: "CSI: Crime Scene Investigation", description: "Uma equipe de cientistas forenses resolve crimes em Las Vegas usando tecnologia avançada.", cover: "images/NV/csi-investigacao-criminal.png", rating: "7.7/10", imdbLink: "https://www.imdb.com/title/tt0247082/" }] },
    ...
    "IA": { name: "Iowa", media: [
        ...
        { type: "Filme", title: "Campos dos Sonhos", description: "Um fazendeiro de Iowa constrói um campo de beisebol em seu milharal, atraindo lendas do esporte.", cover: "images/IA/campos-dos-sonhos.jpg", rating: "7.5/10", imdbLink: "https://www.imdb.com/title/tt0097356/" }, 

        { type: "Filme", title: "As Pontes de Madison", description: "Um fotógrafo da National Geographic se envolve em um romance com uma dona de casa em Iowa.", cover: "images/IA/as-pontes-de-madison.jpg", rating: "7.6/10", imdbLink: "https://www.imdb.com/title/tt0112579/" }] },
    ...
    "NE": { name: "Nebraska", media: [
        ...
        { type: "Filme", title: "Nebraska", description: "Um idoso alcoólatra acredita ter ganhado na loteria e viaja com o filho para receber o prêmio no Nebraska.", cover: "images/NE/nebraska.jpg", rating: "7.7/10", imdbLink: "https://www.imdb.com/title/tt1821549/" }, 

        { type: "Filme", title: "As Sete Faces do Dr. Lao", description: "Um misterioso showman com poderes mágicos visita uma cidade do Velho Oeste no Nebraska.", cover: "images/NE/as-sete-faces-do-dr-lao.jpg", rating: "7.0/10", imdbLink: "https://www.imdb.com/title/tt0058037/" }] },

    "OK": { name: "Oklahoma", media: [

        { type: "Filme", title: "Oklahoma!", description: "Um clássico musical sobre romance e rivalidade em Oklahoma no início do século XX.", cover: "images/OK/oklahoma.jpg", rating: "7.2/10", imdbLink: "https://www.imdb.com/title/tt0048445/" },

        { type: "Filme", title: "Twister", description: "Cientistas buscam tornados em Oklahoma para testar um novo dispositivo de previsão.", cover: "images/OK/twister.jpg", rating: "6.4/10", imdbLink: "https://www.imdb.com/title/tt0117998/" }] },
    ...
    "NH": { name: "Nova Hampshire", media: [
        ...
        { type: "Filme", title: "Jumanji", description: "Duas crianças libertam um homem preso em um jogo de tabuleiro mágico por décadas, ambientado na fictícia Brantford, Nova Hampshire.", cover: "images/NH/jumanji.jpg", rating: "7.0/10", imdbLink: "https://www.imdb.com/title/tt0113497/" }, 

        { type: "Filme", title: "O Resgate do Soldado Ryan", description: "O início e o fim do épico da Segunda Guerra Mundial se passam com o veterano em Nova Hampshire.", cover: "images/NH/o-resgate-do-soldado-ryan.jpg", rating: "8.6/10", imdbLink: "https://www.imdb.com/title/tt0120815/" }] },

    "RI": { name: "Rhode Island", media: [

        { type: "Filme", title: "A Invenção de Hugo Cabret", description: "Um órfão que vive em uma estação de trem em Paris é levado a uma aventura, com cenas iniciais que remetem a Rhode Island.", cover: "images/RI/a-invencao-de-hugo-cabret.png", rating: "7.5/10", imdbLink: "https://www.imdb.com/title/tt0970179/" }, 

        { type: "Filme", title: "Irmãos Gêmeos", description: "Dois irmãos muito diferentes, separados no nascimento, se reencontram em Rhode Island.", cover: "images/RI/irmaos-gemeos.jpg", rating: "6.0/10", imdbLink: "https://www.imdb.com/title/tt0096320/" }] },

    "VT": { name: "Vermont", media: [

        { type: "Filme", title: "Um Hotel Bom Pra Cachorro", description: "Duas crianças órfãs abrigam cachorros de rua em um hotel abandonado, com cenas filmadas em Vermont.", cover: "images/VT/um-hotel-bom-pra-cachorro.jpg", rating: "6.4/10", imdbLink: "https://www.imdb.com/title/tt0785108/" }, 

        { type: "Filme", title: "Super Troopers", description: "Policias rodoviários peculiares de Vermont tentam salvar seus empregos.", cover: "images/VT/super-troopers.jpg", rating: "7.1/10", imdbLink: "https://www.imdb.com/title/tt0232509/" }] },
    ...
    "IL": { name: "Illinois", media: [
        ...
        { type: "Filme", title: "Curtindo a Vida Adoidado", description: "Um estudante do ensino médio em Chicago simula estar doente para passar um dia de aventura na cidade.", cover: "images/IL/curtindo-a-vida-adoidado.jpg", rating: "7.8/10", imdbLink: "https://www.imdb.com/title/tt0091042/" }, 

        { type: "Filme", title: "Os Intocáveis", description: "Um agente federal forma uma equipe para derrubar Al Capone durante a Proibição em Chicago, Illinois.", cover: "images/IL/os-intocaveis.jpg", rating: "7.9/10", imdbLink: "https://www.imdb.com/title/tt0094226/" }] },
    ...
    "KY": { name: "Kentucky", media: [
        ...
        { type: "Filme", title: "Rain Man", description: "Um homem egoísta descobre que tem um irmão autista, e a jornada deles os leva por Kentucky.", cover: "images/KY/rain-man.jpg", rating: "8.0/10", imdbLink: "https://www.imdb.com/title/tt0095953/" }, 

        { type: "Filme", title: "O Gambito da Rainha", description: "Uma órfã prodígio do xadrez, de Kentucky, luta contra o vício enquanto busca o estrelato mundial.", cover: "images/KY/o-gambito-da-rainha.png", rating: "8.6/10", imdbLink: "https://www.imdb.com/title/tt10048342/" }] },
    ...
    "TN": { name: "Tennessee", media: [
        ...
        { type: "Filme", title: "Walk the Line", description: "Biografia de Johnny Cash, mostrando sua ascensão e desafios, com fortes laços com o cenário musical do Tennessee.", cover: "images/TN/walk-the-line.jpg", rating: "7.8/10", imdbLink: "https://www.imdb.com/title/tt0358273/" }, 

        { type: "Série", title: "Nashville", description: "Drama musical que segue a vida de estrelas da música country em Nashville, Tennessee.", cover: "images/TN/nashville.png", rating: "7.5/10", imdbLink: "https://www.imdb.com/title/tt2279188/" }] },
    ...
    "WV": { name: "Virgínia Ocidental", media: [
        ...
        { type: "Filme", title: "Missão Impossível III", description: "Ethan Hunt é forçado a voltar à ativa para enfrentar um traficante de armas. Cenas de ação foram filmadas na Virgínia Ocidental.", cover: "images/WV/missao-impossivel-iii.jpg", rating: "6.9/10", imdbLink: "https://www.imdb.com/title/tt0317917/" }, 

        { type: "Filme", title: "Os Indomáveis", description: "Um rancheiro e seu time enfrentam um barão do gado no Velho Oeste, com cenários que remetem às montanhas da Virgínia Ocidental.", cover: "images/WV/os-indomaveis.jpg", rating: "7.3/10", imdbLink: "https://www.imdb.com/title/tt0468689/" }] },

    "DE": { name: "Delaware", media: [

        { type: "Filme", title: "Clube da Luta", description: "Um homem insone e um vendedor de sabonetes formam um clube da luta. O autor do livro é de Delaware, embora o filme não seja ambientado lá.", cover: "images/DE/clube-da-luta.jpg", rating: "8.8/10", imdbLink: "https://www.imdb.com/title/tt0137523/" }, 

        { type: "Filme", title: "O Curioso Caso de Benjamin Button", description: "A vida de um homem que nasce velho e rejuvenesce ao longo do tempo, com conexões a Wilmington, Delaware.", cover: "images/DE/o-curioso-caso-de-benjamin-button.png", rating: "7.8/10", imdbLink: "https://www.imdb.com/title/tt0818955/" }] },
