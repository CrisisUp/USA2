...
export const stateData = {
    ...
    media: [
      {
        ...
        title: 'La La Land',
        description:
          'Um musical romântico que celebra a magia e os desafios de Los Angeles, com Ryan Gosling e Emma Stone.',
...

      {
        ...
        description:
          'Drama investigativo ambientado na rica comunidade costeira de Monterey, explorando segredos e mentiras.',
...

      {
        ...
        title: 'Pulp Fiction',
        description:
          'Um clássico cult de Quentin Tarantino com múltiplas linhas narrativas interligadas em Los Angeles.',
...

      {
        ...
        description:
          'Três detetives de Los Angeles dos anos 50 se envolvem em uma trama de corrupção e escândalos que expõe o submundo da cidade.',
...

      {
        ...
        description:
          'Na Los Angeles de 1969, um ator de faroestes de TV e seu dublê tentam se manter relevantes enquanto o mundo ao redor muda.',
...

      {
        ...
        description:
          'Um jovem negro talentoso de Los Angeles enfrenta dilemas entre educação, amigos e gangues na década de 1990.',
    ...
    media: [
      {
        ...
        title: 'Taxi Driver',
        description:
          'Um veterano do Vietnã se torna taxista em Nova Iorque, mergulhando na depravação da cidade e planejando a violência.',
    ...
    media: [
      {
        ...
        description:
          'Um caçador encontra uma mala cheia de dinheiro no deserto do Texas, desencadeando uma perseguição brutal.',
...

      {
        ...
        title: 'Apollo 13',
        description:
          'A dramática história real da missão lunar que quase terminou em tragédia, comandada a partir do Texas.',
    ...
    media: [
      {
        ...
        title: 'Miami Vice',
        description:
          'Dois detetives da narcóticos em Miami trabalham disfarçados para combater o crime organizado.',
...

      {
        ...
        title: 'Scarface',
        description:
          'A ascensão e queda de Tony Montana, um imigrante cubano que se torna um poderoso chefão das drogas em Miami.',
    ...
    media: [
      {
        ...
        title: 'A Proposta',
        description:
          'Uma editora de livros canadense força seu assistente a se casar com ela para evitar a deportação, mas as coisas mudam em uma viagem ao Alasca.',
...

      {
        ...
        description:
          'Um jovem médico de Nova York é forçado a praticar medicina em uma pequena cidade remota no Alasca.',
    ...
    media: [
      {
        ...
        description:
          'Um veterinário se apaixona por uma mulher com amnésia anterógrada, tendo que fazê-la se apaixonar por ele todos os dias.',
...

      {
        type: 'Série',
        title: 'Hawaii Five-0',
        description: 'Uma força-tarefa de elite combate o crime nas paradisíacas ilhas do Havaí.',
    ...
    media: [
      {
        ...
        description: 'Um zelador tem que cuidar de seu sobrinho adolescente após a morte do pai.',
    ...
    media: [
      {
        ...
        title: 'Fargo',
        description:
          'Uma esposa é sequestrada e seu marido tenta negociar o resgate, mas as coisas não saem como planejado.',
...

      {
        type: 'Filme',
        title: 'Juno',
        description: 'Uma adolescente grávida toma uma decisão incomum sobre o futuro de seu bebê.',
    ...
    media: [
      {
        ...
        title: 'Yellowstone',
        description:
          'A saga da família Dutton, proprietários da maior fazenda dos EUA, lutando para manter suas terras.',
...

      {
        ...
        title: '1883',
        description:
          'Prequela de Yellowstone que mostra a origem da família Dutton na expansão para Montana.',
    ...
    media: [
      {
        ...
        title: 'Fargo',
        description:
          'Um filme e série com a mesma premissa de crime e humor negro, ambientados no frio Dakota do Norte.',
...

      {
        ...
        title: 'Nomadland',
        description:
          'Uma mulher idosa embarca em uma jornada pelas vastas paisagens da América, incluindo partes de Dakota do Norte, após perder tudo na recessão.',
  ...
  ID: {
    ...
    media: [
      {
        type: 'Filme',
        title: 'Napoleão Dinamite',
        description:
          'Um nerd socialmente desajeitado tenta ajudar seu amigo a vencer as eleições estudantis.',
...

      {
        ...
        description:
          'Dois amigos, um deles narcoléptico, embarcam em uma jornada para encontrar a mãe do primeiro.',
    ...
    media: [
      {
        ...
        description: 'Um ex-presidiário e uma policial se casam e roubam um bebê.',
...

      {
        ...
        title: 'Tombstone',
        description:
          'Wyatt Earp e seus irmãos se mudam para Tombstone, Arizona, onde confrontam foras da lei.',
    ...
    media: [
      {
        ...
        title: 'O Iluminado',
        description:
          'Um escritor aceita um emprego como zelador de inverno em um hotel isolado, que tem um passado sombrio.',
    ...
    media: [
      {
        ...
        description:
          'Quatro amigos viajam para Las Vegas para uma despedida de solteiro que dá muito errado.',
    ...
    media: [
      {
        ...
        title: 'Os Goonies',
        description:
          'Um grupo de crianças encontra um mapa do tesouro e embarca em uma aventura para salvar suas casas.',
    ...
    media: [
      {
        ...
        title: '127 Horas',
        description:
          'A história real de um alpinista que fica preso sob uma rocha em um cânion remoto de Utah.',
    ...
    media: [
      {
        ...
        description: 'A complexa história de amor entre dois cowboys no Wyoming rural.',
...

      {
        ...
        description:
          'Um pistoleiro aposentado é forçado a pegar em armas novamente no Velho Oeste, com locações que remetem ao Wyoming.',
    ...
    media: [
      {
        ...
        title: 'Mud',
        description:
          'Dois meninos descobrem um fugitivo em uma ilha no rio Arkansas e o ajudam a escapar.',
  ...
  IA: {
    ...
    media: [
      {
        type: 'Filme',
        title: 'Campos dos Sonhos',
        description:
          'Um fazendeiro de Iowa constrói um campo de beisebol em seu milharal, atraindo lendas do esporte.',
    ...
    media: [
      {
        ...
        description:
          'Uma garota do Kansas é levada por um tornado para uma terra mágica onde busca ajuda para voltar para casa.',
    ...
    media: [
      {
        ...
        description:
          'Um homem se torna o principal suspeito no desaparecimento de sua esposa no Missouri.',
    ...
    media: [
      {
        ...
        title: 'Nebraska',
        description:
          'Um idoso alcoólatra acredita ter ganhado na loteria e viaja com o filho para receber o prêmio no Nebraska.',
      ...
      {
        type: 'Filme',
        title: 'As Sete Faces do Dr. Lao',
        description:
          'Um misterioso showman com poderes mágicos visita uma cidade do Velho Oeste no Nebraska.',
    ...
    media: [
      {
        ...
        title: 'Oklahoma!',
        description:
          'Um clássico musical sobre romance e rivalidade em Oklahoma no início do século XX.',
...

      {
        ...
        title: 'Twister',
        description:
          'Cientistas buscam tornados em Oklahoma para testar um novo dispositivo de previsão.',
    ...
    media: [
      {
        ...
        title: 'Deadwood',
        description:
          'Um drama de faroeste que retrata a vida em uma cidade sem lei nas Colinas Negras de Dakota do Sul.',
...

      {
        ...
        description:
          'Um piloto tenta provar a existência de dragões, com uma parte da história se passando em Dakota do Sul.',
    ...
    media: [
      {
        ...
        description:
          'Um clássico drama adaptado de Tennessee Williams, ambientado na Nova Orleans da Louisiana.',
    ...
    media: [
      {
        ...
        description:
          'A vida de um homem simples do Alabama que vivencia e influencia eventos históricos importantes.',
...

      {
        ...
        title: 'Selma',
        description:
          'A marcha liderada por Martin Luther King Jr. de Selma a Montgomery, Alabama, pela igualdade de direitos.',
    ...
    media: [
      {
        ...
        description:
          'Jovens aspirantes a escritores e empregadas negras formam um vínculo improvável no Mississippi dos anos 60.',
...

      {
        ...
        description:
          'Um advogado defende um homem negro que assassinou os estupradores de sua filha, no Mississippi.',
    ...
    media: [
      {
        ...
        description: 'Um romance épico que se desenrola na Carolina do Sul durante o século XX.',
    ...
    media: [
      {
        ...
        description:
          'Um estudante do ensino médio em Chicago simula estar doente para passar um dia de aventura na cidade.',
...

      {
        ...
        title: 'Os Intocáveis',
        description:
          'Um agente federal forma uma equipe para derrubar Al Capone durante a Proibição em Chicago, Illinois.',
    ...
    media: [
      {
        ...
        title: 'Hoosiers',
        description:
          'Um treinador com um passado problemático lidera um pequeno time de basquete do ensino médio de Indiana a um campeonato estadual.',
    ...
    media: [
      {
        ...
        title: 'Rain Man',
        description:
          'Um homem egoísta descobre que tem um irmão autista, e a jornada deles os leva por Kentucky.',
    ...
    media: [
      {
        ...
        title: 'Walk the Line',
        description:
          'Biografia de Johnny Cash, mostrando sua ascensão e desafios, com fortes laços com o cenário musical do Tennessee.',
...

      {
        ...
        title: 'Nashville',
        description:
          'Drama musical que segue a vida de estrelas da música country em Nashville, Tennessee.',
    ...
    media: [
      {
        ...
        description:
          'Um drama esportivo baseado na história real de um time de futebol americano escolar integrado racialmente na Virgínia.',
    ...
    media: [
      {
        ...
        description:
          'Uma dama de honra em apuros tenta navegar pelas tradições do casamento e um amor improvável, com algumas cenas em Wisconsin.',
...

      {
        ...
        title: "That '70s Show",
        description:
          'A vida de um grupo de adolescentes nos anos 70 em uma pequena cidade fictícia de Wisconsin.',
  ...
  WV: {
    ...
    media: [
...

      {
        ...
        title: 'Os Indomáveis',
        description:
          'Um rancheiro e seu time enfrentam um barão do gado no Velho Oeste, com cenários que remetem às montanhas da Virgínia Ocidental.',
    ...
    media: [
      {
        ...
        title: 'Rocky',
        description:
          'Um boxeador azarão da Filadélfia, Pensilvânia, tem a chance de lutar pelo título mundial.',
    ...
    media: [
      {
        ...
        description:
          'Um homem é condenado injustamente e passa décadas na prisão de Shawshank, no Maine.',
...

      {
        ...
        title: 'It: A Coisa',
        description:
          'Crianças em uma pequena cidade do Maine são aterrorizadas por uma entidade maligna que se manifesta como um palhaço.',
    ...
    media: [
      {
        ...
        title: 'RoboCop',
        description:
          'Em uma Detroit futurista e decadente, um policial gravemente ferido é transformado em um ciborgue de combate ao crime.',
...

      {
        ...
        title: '8 Mile',
        description:
          'Um jovem rapper branco de Detroit luta para se firmar na cena do hip-hop, numa história inspirada na vida de Eminem.',
